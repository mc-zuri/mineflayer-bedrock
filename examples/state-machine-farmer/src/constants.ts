...
export const LEAF_BLOCKS = [
  ...
  "acacia_leaves", "dark_oak_leaves", "azalea_leaves", "azalea_leaves_flowered"
];

export const TREE_BLOCKS = [...LOG_BLOCKS, ...LEAF_BLOCKS];

export const SAPLING_BLOCKS = [
  "oak_sapling", "birch_sapling", "spruce_sapling",
  "jungle_sapling", "acacia_sapling", "dark_oak_sapling"
];

export const PLANTABLE_GROUND = [
  "dirt", "grass_block", "grass", "podzol", "coarse_dirt", "rooted_dirt", "moss_block", "mud"
];
